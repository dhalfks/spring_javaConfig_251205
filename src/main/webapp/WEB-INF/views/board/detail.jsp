	...
	<div class="container-sm p-5">
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control" 
				id="b" name="bno" value="${board.bno }" readonly>
		</div>
		<div class="mb-3">
			<label for="t" class="form-label">Title</label>
			<input type="text" class="form-control" readonly
				id="t" name="title" value="${board.title }" placeholder="title...">
		</div>
		<div class="mb-3">
			<label for="w" class="form-label">Writer</label>
			<input type="text" class="form-control" readonly
				id="w" name="writer" value="${board.writer }" placeholder="writer...">
		</div>
		<div class="mb-3">
			<label for="r" class="form-label">regDate</label>
			<input type="text" class="form-control" readonly
				id="r" name="regDate" value="${board.regDate }" >
		</div>
		<div class="mb-3">
			<label for="rc" class="form-label">readCount</label>
			<input type="text" class="form-control" readonly
				id="rc" name="readCount" value="${board.readCount }" >
		</div>
		<div class="mb-3">
			<label for="c" class="form-label">Content</label>
			<textarea class="form-control" readonly
				id="c" name="content" rows="3" placeholder="content...">${board.content }</textarea>
		</div>
...
<%-- 		<sec:authorize access="isAnonymous()">
		  <input type="hidden" id="cmtAddBtn" />
		</sec:authorize> --%>
